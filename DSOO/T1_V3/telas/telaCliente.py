...
class TelaCliente:
    ...
    def init_clientes(self, clientes):
        ...
        self.__window_clientes = sg.Window('Clientes', default_element_size=(50,20)).Layout(layout)

    def open_clientes(self, clientes):
        self.init_clientes(clientes)
        botoes, dados = self.__window_clientes.Read()
        if botoes == 'Voltar':
            self.__window_clientes.Close()
        return botoes, dados
